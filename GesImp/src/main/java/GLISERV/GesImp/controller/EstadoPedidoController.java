...
public class EstadoPedidoController {
    ...
    @GetMapping("/{id}")
    public List<EstadoPedido> getByNombre(@RequestParam String nombre) {
        return estadoPedidoService.findByNombre(nombre);
    }
    ...
    public ResponseEntity<EstadoPedido> update(@PathVariable Long id, @RequestBody EstadoPedido estadoPedido) {
        EstadoPedido updated = estadoPedidoService.updateEstadoPedido(id, estadoPedido);
        if (updated != null) {
    ...
    public ResponseEntity<EstadoPedido> patch(@PathVariable Long id, @RequestBody EstadoPedido estadoPedidoParcial) {
        EstadoPedido patched = estadoPedidoService.patchEstadoPedido(id, estadoPedidoParcial);
        if (patched != null) {
