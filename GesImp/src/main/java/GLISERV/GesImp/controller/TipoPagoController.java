...
public class TipoPagoController {
    ...
    @GetMapping("/nombre")
    public List<TipoPago> getByNombre(@RequestParam String nombre) {
        return tipoPagoService.findByNombre(nombre);
    }
    ...
    public ResponseEntity<TipoPago> update(@PathVariable Long id, @RequestBody TipoPago tipoPago) {
        TipoPago updated = tipoPagoService.updateTipoPago(id, tipoPago);
        if (updated != null) {
    ...
    public ResponseEntity<TipoPago> patch(@PathVariable Long id, @RequestBody TipoPago tipoPagoParcial) {
        TipoPago patched = tipoPagoService.patchTipoPago(id, tipoPagoParcial);
        if (patched != null) {
